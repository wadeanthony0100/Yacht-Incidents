...
class IncidentsControllerTest < ActionController::TestCase
  ...
  test "should create incident" do
    assert_difference('Incident.count') do
      post :create, incident: { body: @incident.body, name: @incident.name, who: @incident.who }
    end
  ...
  test "should update incident" do
    put :update, id: @incident, incident: { body: @incident.body, name: @incident.name, who: @incident.who }
    assert_redirected_to incident_path(assigns(:incident))
  end
